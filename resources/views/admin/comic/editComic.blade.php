...
<div class="portlet light">
    ...
    <div class="portlet-body form">
        {!! Form::open(['action' => ['Admin\ComicController@doEditComic','comic_id'=>$comic->comic_id], 'method' => 'POST', 'id'=> 'comic-form', 'files' => true]) !!}
        <div class="form-body">
            <div class="row">
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="txt-name" id="txt-name" class="form-control" value="{{ $comic->comic_name }}"/>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Đơn giá <span class="required"> * </span></label>
                                        <input type="text" name="txt-unit-price" value="{{ $comic->comic_unit_price }}" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="comic_suggest" id="" class="form-control">
                                            <option value="0"
                                            @if($comic->comic_suggest == 0)
                                                {{"selected"}}
                                                    @endif
                                            >Không</option>
                                            <option
                                            @if($comic->comic_suggest == 1)
                                                {{"selected"}}
                                                    @endif
                                            >Có 3</option>
                                            <option value="2"
                                            @if($comic->comic_suggest == 2)
                                                {{"selected"}}
                                                    @endif
                                            >Có 5</option>
                                            <option value="3"
                                            @if($comic->comic_suggest == 3)
                                                {{"selected"}}
                                                    @endif
                                            >Có 3-5</option>
                                        </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group" >
                                ...
                                <textarea class="form-control" name="txt-description" rows="5">{!! $comic->comic_description !!}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-5 {{ ($i + 1) % 2 == 0 ? 'col-md-push-7' : ''}}">
                                                <div>
                                                    @if($comic->comic_contents[$i]->content_image != "")
                                                    <a role="button" data-toggle="modal" data-target="#content-image-{{ ($i + 1) }}">
                                                        <img src="{{ env('APP_URL') . $comic->comic_contents[$i]->content_image}}"
                                                             data-old="{{ env('APP_URL') . $comic->comic_contents[$i]->content_image }}"
                                                             style="max-width: 100%"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="txt-content-image form-control" name="txt-content-image-{{ ($i + 1) }}" value="{{
                                                                      $comic->comic_contents[$i]->content_image != "" ? env('APP_URL') . $comic->comic_contents[$i]->content_image : ''     
                                                                           }}">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-md-7 {{ ($i + 1) % 2 == 0 ? 'col-md-pull-5' : ''}}">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txt-content-title-{{ ($i + 1) }}" class="form-control" value="{{ $comic->comic_contents[$i]->content_title }}"/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Nội dung</label>
                                                    <textarea class="form-control" name="txt-content-text-{{ ($i + 1) }}" rows="8">{!! $comic->comic_contents[$i]->content_text !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="txt-video" class="form-control" value="{{ $comic->comic_video }}" placeholder="https://www.youtube.com/watch?v=NZCkhxhHBto"/>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            <a role="button" data-toggle="modal" data-target="#featured-modal">
                                <img src="{{ env('APP_URL') . $comic->comic_featured}}"
                                     data-old="{{ env('APP_URL') . $comic->comic_featured}}"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">URL ảnh</label>
                                            <input type="text" class="form-control" name="txt-featured" value="{{ env('APP_URL') . $comic->comic_featured }}">
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="txt-meta-title" class="form-control" value="{{ $comic->comic_meta_title }}"/>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Mô tả SEO</label>
                        <textarea class="form-control" name="txt-meta-desc" rows="5">{!! $comic->comic_meta_desc !!}</textarea>
                    </div>
                    <div class="form-group">
