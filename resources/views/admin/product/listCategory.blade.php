...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption uppercase">
            <span class="caption-subject uppercase">Tất cả chuyên mục sản phẩm</span>
        </div>
        <div class="actions">
    ...
    <div class="modal-dialog" style="margin-top: 5%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title uppercase">Thêm chuyên mục sản phẩm</h4>
            </div>
            {!! Form::open(['action' => 'Admin\ProductController@doAddCategory', 'method' => 'POST', 'id'=> 'add-category-form']) !!}
...
<div class="modal fade" id="edit-category-modal" role="dialog">
    <div class="modal-dialog" style="margin-top: 5%">
        <div class="modal-content">
            ...
            {!! Form::open(['action' => 'Admin\ProductController@doEditCategory', 'method' => 'POST', 'id'=> 'edit-category-form']) !!}
            <div class="modal-body">
                <div class="form-group">
...
<div id="delete-modal" class="modal fade" tabindex="-1" data-keyboard="false">
    <div class="modal-dialog"  style="margin-top: 5%">
        <div class="modal-content"><div class="modal-header">
                ...
                <h4 class="modal-title uppercase">Xóa chuyên mục sản phẩm</h4>
            </div>
            {!! Form::open(['action' => 'Admin\ProductController@doDeleteCategory', 'method' => 'POST', 'id' => 'delete-form']) !!}
            <div class="modal-body">
                <input type="hidden" name="txt-id" value="" />
                <div class="font-red-soft">Bạn có chắc chắn muốn xóa chuyên mục sản phẩm này?</div>
            </div>
            <div class="modal-footer">
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-loadcategory').click(function () {
            ...
            modal.modal('show');
            $.ajax({
                url: "{{URL::action('Admin\ProductController@loadCategory')}}",
                type: "GET",
                data: {
