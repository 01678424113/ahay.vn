...
@section('pagecontent')
    ...
    <div class="portlet light">
        ...
        <div class="portlet-body form">
            {!! Form::open(['action' => 'Admin\ProductController@doAddProduct', 'method' => 'POST', 'id'=> 'product-form', 'files' => true]) !!}
            <div class="form-body">
                <div class="row">
                    <div class="col-md-9">
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="txt-sale-percent" class="form-control" value="0"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
