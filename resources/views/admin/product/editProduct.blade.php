...
@section('pagecontent')
    <div class="page-bar m-b-20">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{URL::action('Admin\ProductController@listProduct')}}">Sản phẩm</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <span>{!! $title !!}</span>
        ...
        <div class="page-toolbar">
            <a href="{{URL::action('Admin\ProductController@listProduct')}}" class="btn default btn-sm uppercase">
    ...
    <div class="portlet light">
        ...
        <div class="portlet-body form">
            {!! Form::open(['action' => ['Admin\ProductController@doEditProduct','product_id'=>$product->product_id], 'method' => 'POST', 'id'=> 'product-form', 'files' => true]) !!}
            <div class="form-body">
                <div class="row">
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Mã sản phẩm <span
                                                        class="required"> * </span></label>
                                            <input type="text" name="txt-sku" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="txt-sale-percent" class="form-control"
                                                   value="{{$product->product_sale_percent}}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Sản phẩm nổi bật</label>
                                            <select name="product_suggest" id="" class="form-control">
                                                <option value="0"
                                                @if($product->product_suggest == 0)
                                                    {{"selected"}}
                                                        @endif
                                                >Không</option>
                                                <option value="1"
                                                @if($product->product_suggest == 1)
                                                    {{"selected"}}
                                                        @endif
                                                >Có 3</option>
                                                <option value="2"
                                                @if($product->product_suggest == 2)
                                                    {{"selected"}}
                                                        @endif
                                                >Có 5</option>
                                                <option value="3"
                                                @if($product->product_suggest == 3)
                                                    {{"selected"}}
                                                        @endif
                                                >Có 3-5</option>
                                            </select>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div>
                                <a role="button" data-toggle="modal" data-target="#featured-modal">
                                    <img src="{{ env('APP_URL') . $product->product_featured}}"
                                         data-old="{{ env('APP_URL') . $product->product_featured}}"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="txt-featured"
                                                       value="{{ env('APP_URL') . $product->product_featured }}">
                                            </div>
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="txt-meta-desc"
                                      rows="5">{!! $product->product_meta_desc !!}</textarea>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="icheck-inline">
                                    ...
                                    <label class="control-label" role="button">
                                        <input type="radio" name="rd-status" class="icheck" value="0"
                                               data-radio="iradio_minimal-green"
                                                {{ $product->product_status == 0 ? 'checked' : '' }}
                                        />
            ...
            <div class="form-actions">
                ...
                <a href="{{URL::action('Admin\ProductController@listProduct')}}" data-dismiss="modal"
        ...
        $(document).ready(function () {
            ...
            $('#product-form').validate({
                ...
                messages: {
                    ...
                    'txt-sale-percent': {
                        number: "Số giảm giá không hợp lệ",
                        min: "Số giảm giá phải lớn hơn hoặc bằng 0",
                        max: "Số giảm giá phải nhỏ hơn hoặc bằng 99"
                    },
                    'sl-category': {
