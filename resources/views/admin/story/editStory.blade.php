...
<div class="portlet light">
    ...
    <div class="portlet-body form">
        {!! Form::open(['action' => ['Admin\StoryController@doEditStory','story_id'=>$story->story_id], 'method' => 'POST', 'id'=> 'story-form', 'files' => true]) !!}
        <div class="form-body">
            <div class="row">
                <div class="col-md-9">
                    <div class="form-group">
                        <label class="control-label">Tên truyện <span class="required"> * </span></label>
                        <input type="text" name="txt-name" id="txt-name" class="form-control" value="{{ $story->story_name }}"/>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="sl-comic" id="" class="form-control">
                                    ...
                                    <option value="{{$comic->comic_id}}" 
                                            {{ $story->comic_id ==  $comic->comic_id ? 'selected' : ''}}
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="txt-alpha" value="{{$story->story_alpha}}" class="form-control"/>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="txt-gender" id="" class="form-control">
                                    ...
                                    @elseif($story->story_gender == 'girl')
                                        <option value="boy">Trai</option>
                                        <option value="girl" selected>Gái</option>
                                    @endif
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <a role="button" data-toggle="modal" data-target="#icon-modal">
                                <img src="{{ env('APP_URL') . $story->story_icon }}"
                                     data-old="{{ env('APP_URL') . $story->story_icon }}"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="txt-icon" value="{{  env('APP_URL') . $story->story_icon }}">
                                        </div>
                                    </div>
