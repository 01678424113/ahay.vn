...
<div class="page-bar m-b-20">
    ...
    <div class="page-toolbar">
        <a href="{{URL::action('Admin\OrderController@listOrder')}}" class="btn default btn-sm uppercase"><i
...
<div class="portlet light">
    ...
    <div class="portlet-body form">
        {!! Form::open(['action' => ['Admin\OrderController@doEditOrder','order_id'=>$order->order_id], 'method' => 'POST', 'id'=> 'order-form', 'files' => true]) !!}
        <div class="form-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="txt-email" class="form-control" value="{{ $order->order_email }}"/>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Người mua <span class="required"> * </span></label>
                                        <input type="text" name="txt-name" value="{{ $order->order_name }}" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Số điện thoại<span class="required"> * </span></label>
                                        <input type="text" name="txt-phone" value="{{ $order->order_phone }}" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group" >
                                ...
                                <textarea class="form-control" name="txt-destination" rows="5">{!! $order->order_destination !!}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Tổng tiền<span class="required"> * </span></label>
                                <input type="text" name="txt-total-price" value="{{ $order->order_total_price }}" class="form-control" readonly/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Ngày tạo<span class="required"> * </span></label>
                                <input type="text" name="txt-created-at" value="{{ date('d/m/Y',$order->order_created_at) }}" class="form-control" readonly/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
