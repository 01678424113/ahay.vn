...
@section('pagecontent')
    ...
    <div class="portlet light">
        ...
        <div class="portlet-body form">
            {!! Form::open(['action' => ['Admin\PromotionController@doEditPromotion','promotion_id'=>$promotion->promotion_id], 'method' => 'POST', 'id'=> 'promotion-form', 'files' => true]) !!}
            <div class="form-body">
                <div class="row">
                    <div class="col-md-9">
                        <div class="form-group">
                            <label class="control-label">Tên khuyến mại <span class="required"> * </span></label>
                            <input type="text" name="txt-name" class="form-control" value="{{$promotion->promotion_name}}"/>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Kiểu khuyến mại<span class="required"> * </span></label>
                            <input type="text" name="txt-type" class="form-control" value="{{$promotion->promotion_type}}"/>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Điều kiện<span class="required"> * </span></label>
                            <input type="text" name="txt-condition" class="form-control" value="{{$promotion->promotion_condition}}"/>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Giảm %<span class="required"> * </span></label>
                            <input type="text" name="txt-percent-discount" class="form-control" value="{{$promotion->promotion_percent_discount}}"/>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div>
                                <a role="button" data-toggle="modal" data-target="#featured-modal">
                                    @if(!empty($promotion->promotion_featured))
                                        <img src="{{$promotion->promotion_featured}}"
                                             data-old="{{$promotion->promotion_featured}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="txt-start" class="form-control" value="{{$promotion->promotion_start}}"/>
                        </div>
                        <div class="form-group">
                            <label class="control-label">T.gian kết thúc<span class="required"> * </span></label>
                            <input type="date" name="txt-expired" class="form-control" value="{{$promotion->promotion_expired}}"/>
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-actions">
                <button type="submit" class="btn blue uppercase">Sửa mới</button>
                <a href="{{URL::action('Admin\PromotionController@listPromotion')}}" data-dismiss="modal" class="btn red-soft uppercase">Hủy bỏ</a>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
