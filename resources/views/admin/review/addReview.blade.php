...
@section('pagecontent')
    <div class="page-bar m-b-20">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{URL::action('Admin\ReviewController@listReview')}}">Cảm nhận
                </a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
    ...
    <div class="portlet light">
        ...
        <div class="portlet-body form">
            {!! Form::open(['action' => 'Admin\ReviewController@doAddReview', 'method' => 'POST', 'id'=> 'promotion-form', 'files' => true]) !!}
            {{csrf_field()}}
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="txt_title" class="form-control" value=""/>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Mô tả</label>
                            <textarea class="form-control" name="txt_content" rows="5"></textarea>
                        </div>
                        <div class="form-group">
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#promotion-form').validate({
                ...
                messages: {
                    'txt-name': {
                        required: "Tên người viết không được để trống"
                    },
                    'txt-title': {
