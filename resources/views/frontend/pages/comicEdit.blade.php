...
@section('main_content')
    ...
    {!! Form::open(['action' => ['Frontend\ComicController@doEditComic'], 'method' => 'POST', 'id'=> 'edit-form']) !!}
    {{csrf_field()}}
    <div class="cp-page-content inner-page-content woocommerce"
        ...
        <div class="container-fluid" style="max-width: 1300px;margin: auto;">
            <div class="button-social" style="text-align: center;margin-bottom: 15px;">
                ...
                <div style="margin-bottom: 1px;" class="zalo-share-button" data-href="http://developers.zalo.me"
                     data-oaid="579745863508352884" data-layout="2" data-color="blue" data-customize=false></div>
            </div>
                ...
                <div class="thumbnails-comic-word">
                    <div style="display: inline-flex;justify-content: center;align-items: center;">
                        ...
                        @foreach($stories as $story)
                            <div>
                                <img class="img-thumbnails-word thumbnail-{{$story[0]->story_id}}" data-word-id="{{$i}}" id="thumbnail-{{$i}}"
                                ...
                                <div class="popover fade bottom in"
                                    ...
                                    <div class="popover-content" style="padding: 25px;padding-bottom: 0;padding-top: 28px">
                                            ...
                                            @if($story[0]->story_alpha == $item->story_alpha && $item->story_gender == $comic_gender && in_array($item->story_id,$list_id_stories) == false)
                                                <div class="row" style="margin-bottom: 30px;">
                                                    <div class="col-md-4 col-sm-5 col-xs-5">
                                                        <img style="border: 3px solid #dedede;padding: 1px;border-radius: 5px;height: 46.5px;margin-left: 5px" src="{{$item->story_icon}}" alt="">
                                                    </div>
                                                    {{--  <div class="col-md-4">
                                                          <p style="margin-bottom: 0;margin-top: 10px">{{$item->story_id}}</p>
                                                      </div>--}}
                                                    <div class="col-md-8 col-sm-7 col-xs-7" style="padding-right: 18px;">
                                                        <button type="button"
            ...
            <div class="preview-comic shake" style="overflow: hidden;">
                <div class="Heidelberg-Book with-Spreads" id="Heidelberg-example-1" style="left:-25%">
                    <div class="Heidelberg-Page first-page">
                        ...
                        <span class="hidden-sm hidden-xs" style="position: absolute;z-index: 100;margin-top: 34.8%;margin-right: 5%;margin-left: 80%;font-size: 21px;color: #F08113;"><i class="fa fa-caret-right" aria-hidden="true" style="font-size: 22px;"></i></span>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <textarea name="comic_message" class="form-control textarea-comic-message" cols="30"
                                              rows="13">{{$comic_message}}</textarea>
                                </div>
                            </div>
    ...
    {!! Form::open(['action' => ['Frontend\ComicController@editComic',$comic->comic_slug,$comic->comic_id,$product_sku], 'method' => 'GET', 'id'=> 'preview-form']) !!}
    <input type="hidden" name="comic_user" id="comic-user-preview-form" class="form-control input-lg" value="{{$comic_user}}">
    ...
    <div class="nav-info-preview-comic">
        ...
        <div class="cp-our-staff info-preview-comic hidden-xs hidden-sm">
            <div class="container">
                <div class="col-md-2 info-preview-comic-name">
                    <div>
                        <span>Tên</span>
                ...
                <div class="col-md-3 info-preview-comic-message">
                    <div>
                        <span>Lời nhắn</span>
                        <i class="fa fa-chevron-down" aria-hidden="true"></i>
                        <i class="fa fa-chevron-up" aria-hidden="true"></i>
                ...
                <div class="col-md-2 col-md-offset-5 info-preview-comic-button">
                    <button style="border: 0" form="edit-form" type="submit" class="readmore-bg">Lưu truyện</button>
                </div>
            </div>
        </div>
        ...
        <div class="cp-our-staff info-preview-comic info-preview-comic-mobile hidden-lg hidden-md">
            ...
            <div class="col-md-12 info-preview-comic-button">
                <button class="btn btn-default btn-lg" form="edit-form" type="submit" style="border: 0.2rem solid #3a4d5f;display: block;width: 100%;">Lưu thay đổi</button>
            </div>
        </div>
