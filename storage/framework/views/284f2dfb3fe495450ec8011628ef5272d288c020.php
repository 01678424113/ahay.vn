                    ...
                    <table class="table table-bordered table-hover td-middle">
                        ...
                        <?php foreach($users as $user): ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" data-id="<?php echo e($user->user_id); ?>" class="btn green btn-xs btn-loaduser">
                                        <i class="fa fa-pencil"></i>
                                    </button>
                                    <button type="button" data-id="<?php echo e($user->user_id); ?>" class="btn btn-xs red-soft m-r-0 btn-delete">
    ...
    <div class="modal fade" id="add-user-modal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo Form::open(['action' => ['Admin\UserController@doAddUser'], 'method' => 'POST', 'id'=> 'add-user-form']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="sl-group">
                            ...
                            <?php foreach($groups as $group): ?>
                                <option value="<?php echo e($group->group_id); ?>"><?php echo $group->group_name; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal fade" id="edit-user-modal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo Form::open(['action' => ['Admin\UserController@doEditUser'], 'method' => 'POST', 'id'=> 'edit-user-form']); ?>
    ...
    <div id="delete-modal" class="modal fade" tabindex="-1" data-keyboard="false">
        <div class="modal-dialog"  style="margin-top: 5%">
            <div class="modal-content">
                ...
                <?php echo Form::open(['action' => 'Admin\UserController@doDeleteUser', 'method' => 'POST', 'id' => 'delete-form']); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn-loaduser').click(function () {
                ...
                modal.modal('show');
                $.ajax({
                    url: "<?php echo e(URL::action('Admin\UserController@loadUser')); ?>",
                    type: "GET",
                    data: {
                        user_id: user_id
                    },
