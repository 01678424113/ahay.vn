...
<div class="portlet light">
    ...
    <div class="portlet-body form">
        <?php echo Form::open(['action' => ['Admin\ComicController@doEditComic','comic_id'=>$comic->comic_id], 'method' => 'POST', 'id'=> 'comic-form', 'files' => true]); ?>
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="txt-name" id="txt-name" class="form-control" value="<?php echo e($comic->comic_name); ?>"/>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Đơn giá <span class="required"> * </span></label>
                                        <input type="text" name="txt-unit-price" value="<?php echo e($comic->comic_unit_price); ?>" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Giá tối thiểu <span class="required"> * </span></label>
                                        <input type="text" name="txt-increase-price" value="<?php echo e($comic->comic_increase_price); ?>" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group" >
                                ...
                                <textarea class="form-control" name="txt-description" rows="5"><?php echo $comic->comic_description; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div id="comic-images">
                            <?php if(is_array($comic->comic_images)): ?>
                            <?php foreach($comic->comic_images as $image): ?>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-5 <?php echo e(($i + 1) % 2 == 0 ? 'col-md-push-7' : ''); ?>">
                                                <div>
                                                    <?php if($comic->comic_contents[$i]->content_image != ""): ?>
                                                    <a role="button" data-toggle="modal" data-target="#content-image-<?php echo e(($i + 1)); ?>">
                                                        <img src="<?php echo e(env('APP_URL') . $comic->comic_contents[$i]->content_image); ?>"
                                                             data-old="<?php echo e(env('APP_URL') . $comic->comic_contents[$i]->content_image); ?>"
                                                             style="max-width: 100%"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="txt-content-image form-control" name="txt-content-image-<?php echo e(($i + 1)); ?>" value="<?php echo e($comic->comic_contents[$i]->content_image != "" ? env('APP_URL') . $comic->comic_contents[$i]->content_image : ''); ?>">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-md-7 <?php echo e(($i + 1) % 2 == 0 ? 'col-md-pull-5' : ''); ?>">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txt-content-title-<?php echo e(($i + 1)); ?>" class="form-control" value="<?php echo e($comic->comic_contents[$i]->content_title); ?>"/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Nội dung</label>
                                                    <textarea class="form-control" name="txt-content-text-<?php echo e(($i + 1)); ?>" rows="8"><?php echo $comic->comic_contents[$i]->content_text; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="txt-video" class="form-control" value="<?php echo e($comic->comic_video); ?>" placeholder="https://www.youtube.com/watch?v=NZCkhxhHBto"/>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            <a role="button" data-toggle="modal" data-target="#featured-modal">
                                <img src="<?php echo e(env('APP_URL') . $comic->comic_featured); ?>"
                                     data-old="<?php echo e(env('APP_URL') . $comic->comic_featured); ?>"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">URL ảnh</label>
                                            <input type="text" class="form-control" name="txt-featured" value="<?php echo e(env('APP_URL') . $comic->comic_featured); ?>">
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="txt-meta-title" class="form-control" value="<?php echo e($comic->comic_meta_title); ?>"/>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Mô tả SEO</label>
                        <textarea class="form-control" name="txt-meta-desc" rows="5"><?php echo $comic->comic_meta_desc; ?></textarea>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="icheck-inline">
                                <label class="control-label" role="button">
                                    <input type="radio" name="rd-status" class="icheck" value="1"
                                           ...
                                           <?php echo e($comic->comic_status == 1 ? 'checked' : ''); ?>
                                ...
                                <label class="control-label" role="button">
                                    <input type="radio" name="rd-status" class="icheck" value="0"
                                           data-radio="iradio_minimal-green"
                                           <?php echo e($comic->comic_status == 0 ? 'checked' : ''); ?>
    ...
    $(document).ready(function () {
        Dropzone.options.dropzone = {
            ...
            init: function () {
                ...
                var files = [
<?php
if (is_array($comic->comic_images)) {
    foreach ($comic->comic_images as $image) {
        ?>
                            {
