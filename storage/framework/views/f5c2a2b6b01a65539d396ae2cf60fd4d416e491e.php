...
<div class="portlet light">
    ...
    <div class="portlet-body form">
        <?php echo Form::open(['action' => 'Admin\StoryController@doAddStory', 'method' => 'POST', 'id'=> 'story-form', 'files' => true]); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="sl-comic" id="" class="form-control">
                                    ...
                                    <option value="<?php echo e($comic->comic_id); ?>"><?php echo $comic->comic_name; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
