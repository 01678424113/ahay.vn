...
<html lang="vi">
    <head>
        ...
        <?php echo e(Html::style('assets/style.css')); ?>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid" >
                            ...
                            <li class="nav-item <?php echo e(Request::is('admin/permission*') ? 'active' : ''); ?>">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item <?php echo e(Request::is('admin/permission/group*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(URL::action('Admin\OrderController@listOrder')); ?>" class="nav-link">
        ...
        <?php echo e(Html::script('assets/global/plugins/datatables/datatables.min.js')); ?>

        <?php echo e(Html::script('assets/global/plugins/datatables/datatables.all.min.js')); ?>

        <?php echo e(Html::script('assets/pages/scripts/table-datatables-responsive.min.js')); ?>
