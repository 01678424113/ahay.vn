...
<div class="main-slider hidden-sm hidden-xs">
    <ul class="cp-child-slider">
        <li><img src="/theme/images/mslider1.jpg" alt="" />
            <div class="caption">
                <div class="container">
        ...
        <li><img src="/theme/images/mslider2.jpg" alt="" />
            <div class="caption">
                <div class="container">
                    <div class="slider-data">
        ...
        <li><img src="/theme/images/mslider3.jpg" alt="" />
            <div class="caption">
                <div class="container">
                    <div class="slider-data">
...
<div class="cp-page-content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 <?php echo e($i % 2 == 0 ? 'col-md-push-6' : ''); ?>">
                    <img src="<?php echo e(env('APP_URL') . $comic->comic_featured); ?>" alt="<?php echo e($comic->comic_meta_title); ?>">
                </div>
                <div class="col-md-6 <?php echo e($i % 2 == 0 ? 'col-md-pull-6' : ''); ?>">
                    <div class="welcome-content">
                        ...
                        <a href="#" class="readmore-bg">Tạo câu chuyện</a> 
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="cp-home-welcome">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 <?php echo e($i % 2 == 0 ? 'col-md-push-6' : ''); ?>">
                    <img src="<?php echo e(env('APP_URL') . $product->product_featured); ?>" alt="<?php echo e($product->product_meta_title); ?>">
                </div>
                <div class="col-md-6 <?php echo e($i % 2 == 0 ? 'col-md-pull-6' : ''); ?>">
                    <div class="welcome-content">
                        <h3><?php echo $product->product_name . ' - ' . $product->product_sku; ?></h3>
                        <p><?php echo $product->product_description; ?></p>
                        <a href="#" class="readmore-bg">Xem chi tiết</a> 
                    </div>
                </div>
            </div>
        </div>
