...
<?php $__env->startSection('main_content'); ?>
    ...
    <?php echo Form::open(['action' => ['Frontend\ComicController@doEditComic'], 'method' => 'POST', 'id'=> 'edit-form']); ?>
    ...
    <?php echo Form::open(['action' => ['Frontend\ComicController@editComic',$comic->comic_slug,$comic->comic_id,$product_sku], 'method' => 'GET', 'id'=> 'preview-form']); ?>
        ...
        <div class="cp-our-staff info-preview-comic hidden-xs hidden-sm">
            <div class="container">
                ...
                <div class="col-md-2 col-md-offset-5 info-preview-comic-button">
                    <button style="border: 0" form="edit-form" type="submit" class="readmore-bg">Lưu chỉnh sửa</button>
                </div>
            </div>
        </div>
