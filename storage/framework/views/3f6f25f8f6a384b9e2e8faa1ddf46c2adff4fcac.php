                        ...
                        <?php foreach($products as $product): ?>
                            <li class="col-md-3 col-sm-6">
                                <div class="pro-list">
                                    ...
                                    <div class="thumb"><a
                                                href="<?php echo e(URL::action('Frontend\ProductController@detailProduct',['category_slug'=>$product->category_slug,'product_slug'=>$product->product_slug,'product_id'=>$product->product_id])); ?>"><img
                                    ...
                                    <div class="cart-options">
                                        ...
                                        <a href="<?php echo e(URL::action('Frontend\ProductController@detailProduct',['category_slug'=>$product->category_slug,'product_slug'=>$product->product_slug,'product_id'=>$product->product_id])); ?>">
