                            ...
                            <li class="col-md-3 col-sm-6">
                                <div class="pro-list">
                                    ...
                                    <div class="cart-options">
                                        <a href="<?php echo e(URL::action('Frontend\ActionBuyController@buyProductNow',['product_id'=>$product->product_id])); ?>">
                                            <i class="fa fa-shopping-cart"></i>Mua ngay
                                        </a>
                                        <a class="add_to_cart" data-sku="<?php echo e($product->product_sku); ?>">
                                            <i class="fa fa-heart-o"></i>Yêu thích
                                        </a>
                                        <a href="<?php echo e(URL::action('Frontend\ProductController@detailProduct',['product_slug'=>$product->product_slug,'product_id'=>$product->product_id])); ?>">
