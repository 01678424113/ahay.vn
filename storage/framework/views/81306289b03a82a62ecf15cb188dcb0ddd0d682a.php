            ...
            <div class="col-md-9">
                <nav class="navbar navbar-default main-nav">
                    <div class="navbar-header">
                        ...
                        <a class="logo" href="<?php echo e(URL::action('Frontend\HomeController@index')); ?>"><img
                                    src="<?php echo e(env('APP_URL')); ?>/theme/images/bigmart.png" alt=""></a>
                    </div>
                        ...
                        <ul class="nav navbar-nav menu">
                            <li class="m1">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?php echo e(URL::action('Frontend\ComicController@listComics')); ?>">Sách quà
                                            tặng</a></li>
                                    <li><a href="<?php echo e(URL::action('Frontend\ProductController@listProducts')); ?>">Sản phẩm
                                            khác</a></li>
                                </ul>
                            </li>
                            <li class="m2">
                                    ...
                                    <?php foreach($_COOKIE as $product): ?>
                                        ...
                                        <?php if(isset($product->product_sku)): ?>
                                            <div style="display: flex; margin-bottom: 5px">
                                                <?php if(isset($product->product_featured)): ?>
                                                ...
                                                <?php elseif(isset($product->comic_featured)): ?>
                                                    <img style="width: 50px;margin: 0;height: 50px;margin-right: 10px;"
                                                         src="<?php echo e($product->comic_featured); ?>" alt="">
                                                    <a href=""><?php echo e($product->comic_name); ?>(<?php echo e($product->quantity); ?>)</a>
                                                <?php endif; ?>
                                            </div>
