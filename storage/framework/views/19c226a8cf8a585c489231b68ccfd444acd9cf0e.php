                ...
                <div class="col-md-12">
                            ...
                            <?php if(count($products) > 0 ): ?>
                                <?php foreach($products as $product): ?>
                                    <li>
                                        ...
                                        <div id="myModal-<?php echo e($product->product_sku); ?>" class="modal fade" role="dialog">
                    ...
                    <?php if(session('order_successfully')): ?>
                        <div class="row" style="text-align: center">
                            ...
                            <a href="<?php echo e(URL::action('Frontend\ProductController@otherProducts')); ?>" class="btn btn-info">Click
...
<?php $__env->startSection('script'); ?>
    <script>
        $('.ajax_increase_quantity').click(function () {
            ...
            $.ajax({
                url: 'http://localhost/truyentranh-2/public/ajax-fix-quantity-product/' + product_sku + '/' + quantity,
