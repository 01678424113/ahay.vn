...
<?php echo e(Html::style('assets/global/plugins/bootstrap-summernote/summernote.css')); ?>
...
<div class="page-bar m-b-20">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo e(URL::action('Admin\ArticleController@listArticle')); ?>">Tin tức</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
    ...
    <div class="page-toolbar">
        <a href="<?php echo e(URL::action('Admin\ArticleController@listArticle')); ?>" class="btn default btn-sm uppercase">
...
<div class="portlet light">
    ...
    <div class="portlet-body form">
        <?php echo Form::open(['action' => ['Admin\ArticleController@doEditArticle', 'article_id'=>$article->article_id], 'method' => 'POST', 'id'=> 'article-form', 'files' => true]); ?>
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <input type="text" name="txt-title" id="txt-title" class="form-control"
                               value="<?php echo e($article->article_title); ?>"/>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Tóm tắt</label>
                        <textarea class="form-control" name="txt-summary"
                                  rows="3"><?php echo $article->article_summary; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Nội dung</label>
                        <textarea class="form-control"
                                  name="txt-content"><?php echo $article->article_content; ?></textarea>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            <a role="button" data-toggle="modal" data-target="#featured-modal">
                                <img src="<?php echo e(env('APP_URL') . $article->article_featured); ?>"
                                     data-old="<?php echo e(env('APP_URL') . $article->article_featured); ?>"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="txt-featured" value="<?php echo e(env('APP_URL') . $article->article_featured); ?>">
                                        </div>
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="sl-category">
                            ...
                            <option value="<?php echo e($category->category_id); ?>"
                                    <?php echo e($category->category_id == $article->article_category_id ? 'selected' : ''); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="txt-meta-title" class="form-control"
                               value="<?php echo e($article->article_meta_title); ?>"/>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Mô tả SEO</label>
                        <textarea class="form-control" name="txt-meta-desc"
                                  rows="5"><?php echo $article->article_meta_desc; ?></textarea>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="icheck-inline">
                                <label class="control-label" role="button">
                                    <input type="radio" name="rd-status" class="icheck" value="1"
                                           ...
                                           <?php echo e($article->article_status == 1 ? 'checked' : ''); ?>
                                ...
                                <label class="control-label" role="button">
                                    <input type="radio" name="rd-status" class="icheck" value="0"
                                           data-radio="iradio_minimal-green"
                                           <?php echo e($article->article_status == 0 ? 'checked' : ''); ?>
        ...
        <div class="form-actions">
            ...
            <a href="<?php echo e(URL::action('Admin\ArticleController@listArticle')); ?>" data-dismiss="modal" class="btn red-soft uppercase">Hủy bỏ</a>
        </div>
        <?php echo Form::close(); ?>
...
<?php echo e(Html::script('assets/global/plugins/bootstrap-summernote/summernote.min.js')); ?>

<?php echo e(Html::script('assets/global/plugins/bootstrap-summernote/lang/summernote-vi-VN.min.js')); ?>
...
<script>
            ...
            callbacks: {
                ...
                onPaste: function (e) {
                    ...
                    if (text !== "") {
                        ...
                        $.ajax({
                            url: "<?php echo e(URL::action('Admin\ArticleController@doHandleContent')); ?>",
                            type: "POST",
                            data: {
    ...
    function uploadImage(file, editor, welEditable) {
        ...
        $.ajax({
            data: data,
            type: "POST",
            url: "<?php echo e(URL::action('Admin\ArticleController@doHandleImage')); ?>",
            contentType: false,
            processData: false,
            error: function (jqXHR, textStatus, errorThrow) {
                toastr['error']('Lỗi trong quá trình xử lý dữ liệu');
